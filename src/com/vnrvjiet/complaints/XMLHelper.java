...
/**
 * Utility class for reading and writing XML files (users.xml and complaints.xml).
 * Uses DOM parsing for simplicity.
 */
public class XMLHelper {
    ...
    /**
     * Resolves the absolute path to a data file inside WEB-INF/data/.
     */
    ...
    /**
     * Parses an XML file and returns the Document object.
     */
    ...
    /**
     * Reads all <user> elements from users.xml and returns them as a list of maps.
     */
    ...
    /**
     * Reads all <complaint> elements from complaints.xml and returns them as a list of maps.
     */
    ...
    /**
     * Appends a new <user> element to users.xml.
     */
    ...
    /**
     * Appends a new <complaint> element to complaints.xml.
     */
    ...
    /**
     * Updates a complaint's status and adminRemark by complaint ID.
     */
    ...
    /**
     * Finds a single complaint by ID.
     */
    ...
    /**
     * Returns complaints for a specific student (by studentId).
     */
    ...
    /**
     * Generates the next complaint ID (C001, C002, …).
     */
    ...
    /**
     * Generates the next user ID (U001, U002, …).
     */
